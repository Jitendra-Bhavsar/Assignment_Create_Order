...
5) if you have not see availableQuantity and price in update product catalogue then you need to run update_table module to see update product catalogue. 
"""
